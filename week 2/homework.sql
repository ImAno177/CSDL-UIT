...
SELECT * FROM KyNang WHERE LoaiKyNang = N'Công nghệ';
...
SELECT ChuyenNganh, COUNT(*) AS SoLuongChuyenGia FROM ChuyenGia GROUP BY ChuyenNganh;
...
-- Liệt kê tên các công ty có số nhân viên từ 100 đến 200 và tính trung bình số nhân viên của họ. Sắp xếp kết quả theo tên công ty tăng dần.
